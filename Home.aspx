<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="BloodDonation.com.Home" %>
    ...
    <div class="row">
     ...
     <div id="d2">
            ...
            <div class="d1">
                ...
                <img src="img/rq.PNG" class="img2"/></a>
            </div>
            <div class="d1">
                <a href="BloodBankStock.aspx">
                <img src="img/d2.PNG" class="img2"/></a>
            </div>
            <div class="d1">
                <a href="BloodRequest.aspx">
                <img src="img/d4.PNG" class="img2"/></a>
            </div>
        </div>
